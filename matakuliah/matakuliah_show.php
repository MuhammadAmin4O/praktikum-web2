    ...
    <div class="card-body">
        <form action="?page=mahasiswa-show" method="POST">
            <div class=" input-group mb-3">
                <input type="text" class="form-control" placeholder="Masukan Kode..." name="keyword">
        ...
        <nav class="mb-5">
            <ul class="pagination justify-content-end">
                ...
                if ($page == 1) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href="?page=matakuliah-show&halaman=' . $link_prev . '" aria-
label="Previous"><span aria-hidden="true">&laquo;</span></a></li>';
                ...
                if ($page == $jumlah_page) {
                    ...
                    echo '<li class="page-item"><a class="page-link" href="?page=matakuliah-show&halaman=' . $link_next . '" aria-
